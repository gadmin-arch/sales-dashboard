...
import { Store, Wallet, Crown, Users, Loader2, Search } from 'lucide-react'
    ...
    <SalesPageShell>
      <div className="bg-background text-foreground min-h-screen space-y-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div><h1 className="text-2xl font-bold tracking-tight">Vendor Scorecard</h1><p className="text-sm text-muted-foreground">PT. Multi Daya Mitra — Supplier Spend</p></div>
          <ThemeToggle />
        </div>
